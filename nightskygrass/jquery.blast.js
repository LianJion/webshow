...
;(function ($, window, document, undefined) {
    ...
    *****************/
    ...
    var NAME = "blast",
        characterRanges = {
            //这个乱码注释掉就可以用了，我的天，感谢王洁同学！
            latinPunctuation: "–—′’'“″„\"(«.…¡¿′’'”″“\")».…!?",
            // latinPunctuation: "鈥撯€斺€测€�'鈥溾€斥€瀄"(芦.鈥β÷库€测€�'鈥濃€斥€淺")禄.鈥�!?",
        ...
        ***********************/
        ...
        if (opts.search.length && (typeof opts.search === "string" || /^\d/.test(parseFloat(opts.search)))) {
            ...
            /* Note: By creating boundaries at Latin alphabet ranges instead of merely spaces, we effectively match phrases that are inlined alongside any type of non-Latin-letter,
               e.g. word|, word!, 鈾ord鈾� will all match. */
            ...
            switch (opts.delimiter) {
                ...
                case "sentence":
                    ...
                    /* RegExp explanation (Tip: Use Regex101.com to play around with this expression and see which strings it matches): 
                       ...
                       - ([.鈥�!?]+|(?=\s+$)|$) --> Match the last occurrence of sentence-final punctuation or the end of the text (optionally with left-side trailing spaces).
                       - (\s*[鈥测€�'鈥濃€斥€�")禄]+)* --> After the final punctuation, match any and all pairs of (optionally space-delimited) quotes and parentheses.
                    */
                    break;
